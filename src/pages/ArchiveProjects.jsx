...
//         <div className="font-poppins text-center text-3xl">My Projects:</div>
//       </div>
...
//           >
//             <h2 className="font-poppins mb-2 cursor-pointer text-lg font-semibold lg:text-2xl">
//               {project.name}
//             </h2>
//             <ul className="font-poppins text-base text-gray-900 list-disc pl-4">
...
//                 <p
//                   key={index}
//                   className="mb-2 mr-2 inline-block rounded-full bg-transparent px-3 py-1 text-base font-semibold text-gray-900 shadow-md"
//                 >
//                   {tech}
//                 </p>
//               ))}
